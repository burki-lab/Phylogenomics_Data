...
3. 3_Merge.sh  
4. 4_Untagged_paralogs.sh - This find the untagged paralogs from the dataset using a regex pattern with "(_underscore_)word-(dash)" where the word depends on the gene name.
