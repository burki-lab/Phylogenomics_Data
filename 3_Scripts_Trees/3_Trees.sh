#Uppmax script for alignment and tree making with default settings
...
### SETTINGS
OUTDIR=/proj/uppstore2018069/Harshal/3_Trees  #the directory where you want the files to be saved 
...
##### Run IQTree
	...
	OUTPUT=$m.IQtree
	iqtree -s $INPUT -m TEST -bb 1000 -alrt 1000 -st AA -nt 2 -pre $OUTPUT
